...
//enum Tag{study,read,exercise,relax,science,art,music,history,interact,write};
//enum Actime{Mevening,Tuevening,Wevening,Thevening,Fevening,Satmorning,Satafternoon,Satevening,Sunmorning,Sunafternoon,Sunevening};
